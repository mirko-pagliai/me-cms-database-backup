...
namespace MeCms\DatabaseBackup\Form;
 ...
 * @see \MeCms\DatabaseBackup\Controller\Admin\BackupsController::add()
 */
class BackupForm extends Form
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator->add('filename', [
            ...
            'extension' => [
                'message' => __d('me_cms/database_backup', 'Valid extensions: {0}', 'sql, sql.gz, sql.bz2'),
